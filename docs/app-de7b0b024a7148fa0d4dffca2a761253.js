...
if(s.name===t)return s}}function $(){return new Error("Not implemented")}function G(e){return function(t){return Array.isArray(t)&&t[0]===e}}function W(e,t){let n=new Cs(t)
...
return e.length}function ee(e=new Ws,t=new Js){return e.add("if",(e,t,s,r,i)=>{if(!e||1!==e.length)throw new Error(`SYNTAX ERROR: #if requires a single argument`)
...
return t}function $e(e,t){if(!t)throw new Error("Assertion Failed: "+e)}function Ge(...e){let t=e[0],n=e[1],s=e[2]
return"string"==typeof t?function(t,n,s){return We(t,n,s,e)}:s?We(t,n,s,[]):void Je(t,n)}function We(e,t,n,s){let r=Xe(e)
...
return s&&(t?e[Ui]=n:delete e[Ui]),r}function st(e){return qi.call(e)}function rt(e){return null==e?void 0===e?zi:Yi:Vi&&Vi in Object(e)?nt(e):st(e)}function it(e){return null!=e&&"object"==typeof e}function at(e){if(!it(e)||rt(e)!=Gi)return!1
var t=$i(e)
if(null===t)return!0
...
const Gt=Vt?Object.freeze([]):[]
var Wt;(function(e){e[e.pc=0]="pc",e[e.ra=1]="ra",e[e.fp=2]="fp",e[e.sp=3]="sp",e[e.s0=4]="s0",e[e.s1=5]="s1",e[e.t0=6]="t0",e[e.t1=7]="t1"})(Wt||(Wt={}))
...
n=t.peek(),e.updateWith(new Ln(t))}e.elements().pushRemoteElement(t,n)}),Kt.add(37,e=>e.elements().popRemoteElement()),Kt.add(33,e=>{let t=e.fetchValue(Wt.t0)
t&&(t.flush(e),e.loadValue(Wt.t0,null)),e.elements().flushElement()}),Kt.add(34,e=>e.elements().closeElement()),Kt.add(35,(e,{op1:t})=>{let n=e.constants.getOther(t),s=e.stack.pop()
var r=e.elements()
...
{let s=parseInt(e,10)
return s<0||s>=n?Sn:t[s]}}valueOf(e){return e.value()}}class Yn{constructor(){this.length=0,this._tag=null,this._references=null,this._names=null,this._realNames=Gt}setup(e,t,n,s){this.stack=e,this.length=t,this._tag=null,this._references=null,s?(this._names=n,this._realNames=Gt):(this._names=null,this._realNames=n)}get tag(){return f(this.references)}get names(){let e=this._names
...
l.component=c
let u=i.getTag(c)
g(u)||e.updateWith(new Wn(u,r.name,c,i,o))}),Kt.add(61,(e,{op1:t})=>{var n=e.fetchValue(t)
let s=n.manager,r=n.component,i=s.getDestructor(r)
i&&e.newDestroyable(i)}),Kt.add(65,e=>{e.beginCacheGroup(),e.elements().pushSimpleBlock()}),Kt.add(62,e=>{e.loadValue(Wt.t0,new $n)}),Kt.add(32,(e,{op1:t,op2:n,op3:s})=>{let r=e.constants.getString(t),i=e.stack.pop(),a=s?e.constants.getString(s):null
e.fetchValue(Wt.t0).setAttribute(r,i,!!n,a)})
...
"class"===t&&(s=new Gn(this.classes))
let a=e.elements().setDynamicAttribute(t,s.value(),i,r)
m(s)||e.updateWith(new Hn(s,a))}}}class Gn{constructor(e){this.list=e,this.tag=f(e),this.list=e}value(){let e=[],t=this.list
...
let s=n.manager,r=n.component,i=e.fetchValue(Wt.t0)
...
class Wn extends Qt{constructor(e,t,n,s,r){super(),this.tag=e,this.name=t,this.component=n,this.manager=s,this.dynamicScope=r,this.type="update-component"}evaluate(e){let t=this.component,n=this.manager,s=this.dynamicScope
...
var _s;(function(e){e.isUnknown=G(ws.Unknown),e.isGet=G(ws.Get),e.isConcat=G(ws.Concat),e.isHelper=G(ws.Helper),e.isHasBlock=G(ws.HasBlock),e.isHasBlockParams=G(ws.HasBlockParams),e.isUndefined=G(ws.Undefined),e.isClientSide=G(ws.ClientSideExpression),e.isMaybeLocal=G(ws.MaybeLocal),e.isPrimitiveValue=function(e){return null===e||"object"!=typeof e}})(_s||(_s={}))
var xs;(function(e){function t(e){return e[0]===ws.StaticAttr||e[0]===ws.DynamicAttr||e[0]===ws.TrustingAttr}function n(e){return e[0]===ws.StaticArg||e[0]===ws.DynamicArg}e.isText=G(ws.Text),e.isAppend=G(ws.Append),e.isComment=G(ws.Comment),e.isModifier=G(ws.Modifier),e.isBlock=G(ws.Block),e.isComponent=G(ws.Component),e.isOpenElement=G(ws.OpenElement),e.isFlushElement=G(ws.FlushElement),e.isCloseElement=G(ws.CloseElement),e.isStaticAttr=G(ws.StaticAttr),e.isDynamicAttr=G(ws.DynamicAttr),e.isYield=G(ws.Yield),e.isPartial=G(ws.Partial),e.isDynamicArg=G(ws.DynamicArg),e.isStaticArg=G(ws.StaticArg),e.isTrustingAttr=G(ws.TrustingAttr),e.isDebugger=G(ws.Debugger),e.isClientSide=G(ws.ClientSideStatement),e.isAttribute=t,e.isArgument=n,e.isParameter=function(e){return t(e)||n(e)},e.getParameterName=function(e){return e[1]}})(xs||(xs={}))
...
if(i.startLabels(),s?(i.fetch(Wt.s1),Q(s,i),i.dup(),i.load(Wt.s1),i.test("simple"),i.jumpUnless("BODY"),i.fetch(Wt.s1),i.putComponentOperations(),i.openDynamicElement()):r&&(i.putComponentOperations(),i.openElementWithOperations(r)),s||r){i.didCreateElement(Wt.s0)
let e=this.attrs.buffer
i.setComponentAttrs(!0)
for(let t=0;t<e.length;t++)te(e[t],i)
i.setComponentAttrs(!1),i.flushElement()}i.label("BODY"),i.invokeStatic(t.asBlock()),s?(i.fetch(Wt.s1),i.test("simple"),i.jumpUnless("END"),i.closeElement()):r&&i.closeElement(),i.label("END"),i.didRenderLayout(Wt.s0),s&&i.load(Wt.s1),i.stopLabels()
let a=i.start
i.finalize()
...
this.push(25,t)}modifier(e){this.push(35,this.other(e))}putIterator(){this.push(54)}enterList(e){this.reserve(52),this.labels.target(this.pos,52,e)}exitList(){this.push(53)}iterate(e){this.reserve(55),this.labels.target(this.pos,55,e)}setVariable(e){this.push(4,e)}getVariable(e){this.push(5,e)}getProperty(e){this.push(6,this.string(e))}getBlock(e){this.push(8,e)}hasBlock(e){this.push(9,e)}hasBlockParams(e){this.push(10,e)}concat(e){this.push(11,e)}function(e){this.push(2,this.func(e))}load(e){this.push(17,e)}fetch(e){this.push(18,e)}dup(e=Wt.sp,t=0){return this.push(15,e,t)}pop(e=1){return this.push(16,e)}pushRemoteElement(){this.push(36)}popRemoteElement(){this.push(37)}label(e){this.labels.label(e,this.nextPos)}pushRootScope(e,t){this.push(19,e,t?1:0)}pushChildScope(){this.push(20)}popScope(){this.push(21)}returnTo(e){this.reserve(23),this.labels.target(this.pos,23,e)}pushDynamicScope(){this.push(39)}popDynamicScope(){this.push(40)}pushImmediate(e){this.push(13,this.other(e))}primitive(e){let t,n=0
...
for(let e=0;e<r;e++)this.dup(Wt.fp,t-e),this.setVariable(n[e])}let i=this.constants.block(e)
...
if(t){r=t[0]
let e=t[1]
for(let t=0;t<e.length;t++)Q(e[t],this)}this.pushImmediate(r),this.pushArgs(n)}compile(e){return K(e)?e.compile(this):e}guardedAppend(e,t){this.startLabels(),this.pushFrame(),this.returnTo("END"),Q(e,this),this.dup(),this.test(e=>Qn.create(e)),this.enter(2),this.jumpUnless("ELSE"),this.pushDynamicComponentManager(),this.invokeComponent(null,null,null,null,null),this.exit(),this.return(),this.label("ELSE"),this.dynamicContent(t),this.exit(),this.return(),this.label("END"),this.popFrame(),this.stopLabels()}invokeComponent(e,t,n,s,r=null){this.fetch(Wt.s0),this.dup(Wt.sp,1),this.load(Wt.s0),this.pushBlock(s),this.pushBlock(r),this.compileArgs(t,n,!1),this.prepareArgs(Wt.s0),this.beginComponentTransaction(),this.pushDynamicScope(),this.createComponent(Wt.s0,null!==s,null!==r),this.registerComponentDestructor(Wt.s0),this.getComponentSelf(Wt.s0),this.getComponentLayout(Wt.s0),this.invokeDynamic(new qs(e&&e.scan())),this.popFrame(),this.popScope(),this.popDynamicScope(),this.commitComponentTransaction(),this.load(Wt.s0)}template(e){return e?new Ns(this.meta,e.statements,e.parameters):null}}var Rs=ws
const Is="&attrs"
...
if(t.env.hasComponentDefinition(n,t.meta.templateMeta)){let e=t.template(i),a=[[Rs.ClientSideStatement,Es.SetComponentAttrs,!0],...s,[Rs.ClientSideStatement,Es.SetComponentAttrs,!1]],o=new Ns(t.meta,a,Gt),l=t.env.getComponentDefinition(n,t.meta.templateMeta)
...
t.startLabels(),t.pushFrame(),t.returnTo("END"),Q(n,t),t.pushImmediate(1),t.pushImmediate(Gt),t.pushArgs(!0),t.helper(function(e,t){let n=e.env
...
t.env.hasHelper(n,t.meta.templateMeta)?Vs.compile([Rs.Helper,n,Gt,null],t):t.meta.asPartial?t.resolveMaybeLocal(n):(t.getVariable(0),t.getProperty(n))}),Vs.add(Rs.Concat,(e,t)=>{let n=e[1]
...
class Ws{constructor(){this.names=p(),this.funcs=[]}add(e,t){this.funcs.push(t),this.names[e]=this.funcs.length-1}addMissing(e){this.missing=e}compile(e,t,n,s,r,i){let o=this.names[e]
...
return!1===e?["expr",n]:e}return["expr",n]}}ee(new Ws,new Js)
...
return new Ks(t,{meta:e,parameters:Gt})}scanLayout(e,t,n){let s=this.block,r=s.symbols,i=s.hasEval,a=new Zs(s,this.env,e,t,n)
...
this.state=2
let s=e.push(Is)
t.push(...n),t.push([Xs.Yield,s,Gt]),t.push([Xs.ClientSideStatement,Es.SetComponentAttrs,!1])}t.push(e)}}class er{constructor(){this.references=[],this.strings=[],this.expressions=[],this.arrays=[],this.blocks=[],this.functions=[],this.others=[]}getReference(e){return this.references[e-1]}reference(e){let t=this.references.length
...
return this.stack.slice(n,t)}reset(){this.stack.length=0}toArray(){return this.stack.slice(this.fp,this.sp+1)}}class Ur{constructor(e,t,n,s){this.env=e,this.elementStack=s,this.dynamicScopeStack=new Ut,this.scopeStack=new Ut,this.updatingOpcodeStack=new Ut,this.cacheGroups=new Ut,this.listBlockStack=new Ut,this.stack=Fr.empty(),this.pc=-1,this.ra=-1,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.env=e,this.heap=e.program.heap,this.constants=e.program.constants,this.elementStack=s,this.scopeStack.push(t),this.dynamicScopeStack.push(n)}get fp(){return this.stack.fp}set fp(e){this.stack.fp=e}get sp(){return this.stack.sp}set sp(e){this.stack.sp=e}fetch(e){this.stack.push(this[Wt[e]])}load(e){this[Wt[e]]=this.stack.pop()}fetchValue(e){return this[Wt[e]]}loadValue(e,t){this[Wt[e]]=t}pushFrame(){this.stack.push(this.ra),this.stack.push(this.fp),this.fp=this.sp-1}popFrame(){this.sp=this.fp-1,this.ra=this.stack.fromBase(0),this.fp=this.stack.fromBase(-1)}goto(e){this.pc=i(this.pc+e)}call(e){let t=this.heap.getaddr(e)
...
return e in t?t[e]:null}path(e){return e.split(".").reduce((e,t)=>e.get(t),this)}referenceFromParts(e){return e.reduce((e,t)=>e.get(t),this)}label(){return"[reference Root]"}}const Gr={destroy(){}}
class Wr{constructor(e,t){this.tag=rn,this.parent=e}chain(){return Gr}notify(){}value(){return this.parent[this.property]}get(e){return new Wr(this.parent[this.property],e)}}class Jr{constructor(e){this.tag=rn,this.inner=e}update(e){this.inner=e}chain(){return Gr}notify(){}value(){return this.inner}referenceFromParts(e){throw new Error("Not implemented")}chainFor(e){throw new Error("Not implemented")}get(e){return new Wr(this.inner,e)}}class Kr{constructor(e){this.object=e}root(){return new Jr(this.object)}}const Xr="df8be4c8-4e89-44e2-a8f9-550c8dacdca7",Qr=Object.hasOwnProperty
...
i>3&&a&&Object.defineProperty(t,n,a)})([Ge],na.prototype,"state",void 0)
...
e<=11?this._dispatch(la,e):this.nextYear()}}ya([Ge],ba.prototype,"state",void 0),ya([Ge("state")],ba.prototype,"inputValue",null),ya([Ge("state")],ba.prototype,"days",null),ya([Ge("state")],ba.prototype,"monthToString",null),ya([Ge("state")],ba.prototype,"yearsIndex",null),ya([Ge("state")],ba.prototype,"years",null),ya([Ge("years")],ba.prototype,"firstYear",null),ya([Ge("years")],ba.prototype,"lastYear",null)
...
i>3&&a&&Object.defineProperty(t,n,a)})([Ge("args")],xa.prototype,"days",null)
...
return a&&o?l=o(l,a):o&&(l=o(l)),l}}La([Ge("args")],Ba.prototype,"path",null),La([Ge("args")],Ba.prototype,"match",null)
...
ft($a)
var Ga=yt(function(e,t){t.__esModule=!0
...
ft(Ga)
var Wa=ft(yt(function(e,t){function n(e){return e&&e.__esModule?e:{default:e}}t.__esModule=!0
...
t.default=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};(0,a.default)(Ga.canUseDOM,"Browser history needs a DOM")
var t=window.history,n=(0,Ga.supportsHistory)(),h=!(0,Ga.supportsPopStateOnHashChange)(),c=e.forceRefresh,u=void 0!==c&&c,p=e.getUserConfirmation,d=void 0===p?Ga.getConfirmation:p,m=e.keyLength,g=void 0===m?6:m,f=e.basename?(0,qa.stripTrailingSlash)((0,qa.addLeadingSlash)(e.basename)):"",y=function(e){var t=e||{},n=t.key,s=t.state,r=window.location,a=r.pathname+r.search+r.hash
return(0,i.default)(!f||(0,qa.hasBasename)(a,f),'You are attempting to use a basename on a page whose URL path does not begin with the basename. Expected path "'+a+'" to begin with "'+f+'".'),f&&(a=(0,qa.stripBasename)(a,f)),(0,Va.createLocation)(a,s,n)},b=function(){return Math.random().toString(36).substr(2,g)},v=(0,o.default)(),k=function(e){r(N,e),N.length=t.length,v.notifyListeners(N.location,N.action)},w=function(e){(0,Ga.isExtraneousPopstateEvent)(e)||E(y(e.state))},_=function(){E(y(l()))},x=!1,E=function(e){x?(x=!1,k()):v.confirmTransitionTo(e,"POP",d,function(t){t?k({action:"POP",location:e}):S(e)})},S=function(e){var t=N.location,n=C.indexOf(t.key);-1===n&&(n=0)
var s=C.indexOf(e.key);-1===s&&(s=0)
var r=n-s
r&&(x=!0,P(r))},A=y(l()),C=[A.key],O=function(e){return f+(0,qa.createPath)(e)},P=function(e){t.go(e)},T=0,D=function(e){1===(T+=e)?((0,Ga.addEventListener)(window,"popstate",w),h&&(0,Ga.addEventListener)(window,"hashchange",_)):0===T&&((0,Ga.removeEventListener)(window,"popstate",w),h&&(0,Ga.removeEventListener)(window,"hashchange",_))},M=!1,N={length:t.length,action:"POP",location:A,createHref:O,push:function(e,r){(0,i.default)(!("object"===(void 0===e?"undefined":s(e))&&void 0!==e.state&&void 0!==r),"You should avoid providing a 2nd state argument to push when the 1st argument is a location-like object that already has state; it is ignored")
...
i>3&&a&&Object.defineProperty(t,n,a)})([Ge],Ja.prototype,"pathname",void 0)
...
return Wa({basename:n,forceRefresh:r,keyLength:a,getUserConfirmation:void 0===o?(e,t)=>t(window.confirm(e)):o})}}(function(e,t,n,s){var r,i=arguments.length,a=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,n):s
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,s)
else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(a=(i<3?r(a):i>3?r(t,n,a):r(t,n))||a)
i>3&&a&&Object.defineProperty(t,n,a)})([Ge],Ka.prototype,"pathname",void 0)
...
t.default=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};(0,i.default)(Ga.canUseDOM,"Hash history needs a DOM")
var t=window.history,n=(0,Ga.supportsGoWithoutReloadUsingHash)(),u=e.getUserConfirmation,p=void 0===u?Ga.getConfirmation:u,d=e.hashType,m=void 0===d?"slash":d,g=e.basename?(0,qa.stripTrailingSlash)((0,qa.addLeadingSlash)(e.basename)):"",f=o[m],y=f.encodePath,b=f.decodePath,v=function(){var e=b(l())
...
r&&(_=!0,D(r))},C=l(),O=y(C)
C!==O&&c(O)
var P=v(),T=[(0,qa.createPath)(P)],D=function(e){(0,r.default)(n,"Hash history go(n) causes a full page reload in this browser"),t.go(e)},M=0,N=function(e){1===(M+=e)?(0,Ga.addEventListener)(window,"hashchange",E):0===M&&(0,Ga.removeEventListener)(window,"hashchange",E)},L=!1,B={length:t.length,action:"POP",location:P,createHref:function(e){return"#"+y(g+(0,qa.createPath)(e))},push:function(e,t){(0,r.default)(void 0===t,"Hash history cannot push state; it is ignored")
...
i>3&&a&&Object.defineProperty(t,n,a)})([Ge],Qa.prototype,"pathname",void 0)
...
i>3&&a&&Object.defineProperty(t,n,a)})([Ge],eo.prototype,"pathname",void 0)
...
const a=void 0===i?6:i
var o=e.getUserConfirmation
return Wa({basename:n,forceRefresh:r,keyLength:a,getUserConfirmation:void 0===o?(e,t)=>t(window.confirm(e)):o})}}var io=function(e,t,n,s){var r,i=arguments.length,a=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,n):s
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,s)
else for(var o=e.length-1;o>=0;o--)(r=e[o])&&(a=(i<3?r(a):i>3?r(t,n,a):r(t,n))||a)
...
this.pickSlide(t)}}io([Ge],ao.prototype,"slideWidth",void 0),io([Ge],ao.prototype,"currentIndex",void 0),io([Ge("slideWidth")],ao.prototype,"slideHeight",null),io([Ge("slideWidth","currentIndex")],ao.prototype,"slidesOffset",null)
...
return i>3&&a&&Object.defineProperty(t,n,a),a}
class Po extends na{constructor(){super(...arguments),this.state=Co}get counter(){return this.state}mapStateToLocaleState(e){return e.counter}mapDispatchToActions(){return{increment:xt,decrement:Et,clearCounter:St}}}Oo([Ge],Po.prototype,"state",void 0),Oo([Ge("state")],Po.prototype,"counter",null)
